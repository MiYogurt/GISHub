        ...
        <div class="container-fluid">
            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"><i class="icon-user"></i></span>
                    <h5>所有用户</h5>
                    <a class="btn btn-mini btn-info" href="{{ url('/hub/adduser') }}" style="float: right;padding: 7px;">添加用户</a>
                </div>
                    ...
                    <table class="table table-bordered data-table">
                        ...
                        <tr class="gradeX">
                            ...
                            <td class="center" style="text-align: center;">
                                ...
                                {{--<a class="btn btn-mini btn-info" href="">修改</a>--}}

                                {{--<form action="{{ url('/hub/user/delete/'.$user->id) }}" method="post" style="display: inline-block;">--}}
