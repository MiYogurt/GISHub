...
<form class="form-group" enctype="multipart/form-data" action="{{ url('hub/share') }}" method="post">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <input type="hidden" name="_method" value="POST"/>
    <div>
        <label class="label label-success" style="position:relative;top:-2px;margin-left:5px;">文章标题</label>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="text" name="title" value="{{ old('title') }}" style="margin-top: 2px;width: 500px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label class="label label-success" style="margin-left:5px;position:relative;top:-2px;margin-right:5px">请选择分类</label>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="radio" name="cate" value="1" checked="checked"  />技术
        <input type="radio" name="cate" value="2" />情感
        <input type="radio" name="cate" value="3" />生活
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
