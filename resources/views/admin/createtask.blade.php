        ...
        <div class="container-fluid">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form action="{{ url('/hub/task') }}" method="post" class="form-horizontal">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="project_id" value="{{ $project_id }}">
                        <div class="control-group">
                            <label class="control-label">任务名称 :</label>
                            <div class="controls">
                                <input type="text" name="name" value="{{ old('name') }}" class="span8">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">任务内容 :</label>
                            <div class="controls">
                                <textarea style="height: 200px;" class="span8" value="{{ old('message') }}" name="content"></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">完成时间 :</label>
                            <div class="controls">
                                <input type="date" name="finish_time" value="">
                            </div>
                        </div>
