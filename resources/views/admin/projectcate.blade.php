...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered table-invoice">
                    ...
                    <tr>
                        <td style="width:150px">项目简介:</td>
                        <td style="max-width: 400px;white-space: normal;overflow: hidden">{{ $project->description }}</td>
                    </tr>
                    <tr>
                        <td style="width:150px">项目负责人:</td>
                        <td>{{ $duty_name }}</td>
                    </tr>
                    <tr>
                        <td style="width:150px">项目成员组:</td>
                        <td>{{ $users }}</td>
                    </tr>
                    <tr>
                        <td style="width:150px">预期完成时间:</td>
        ...
        <div class="widget-box">
            <div class="widget-title"> <span class="icon"><i class="icon-bullhorn"></i></span>
                <h5>任务列表</h5>
                <a class="btn btn-mini btn-info" href="{{ url('hub/'.$project->id.'/task/create') }}" style="float: right;padding: 7px;">创建一个新任务</a>
            </div>
            <div class="widget-content nopadding">
                <table class="table table-bordered data-table">
                    ...
                    @foreach ($tasks as $task)
                        <tr class="gradeX">
                            ...
                            <td style="text-align: center">{{ $task->status?"已完成":"进行中" }}</td>
                            <td class="center" style="text-align: center">
                                {{-- <a class="btn btn-mini btn-info" href="{{ url('/hub/task/'.$task->id) }}">查看</a> --}}

                                <div class="btn-group">
                                            <form action="{{ url('/hub/task/'.$task->id) }}" method="post" style="display: block;">
